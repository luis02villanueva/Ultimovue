        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="submenu">
                        <a href="#"><i class="fas fa-graduation-cap"></i> <span> Categorias</span> <span class="menu-arrow"></span></a>
                        <ul>
                            <li>
                                <router-link :to="{name:'categorias'}">Lista de categorias</router-link>
                            </li>
